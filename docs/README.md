...
```
├── src/wagtail_mcp/   # The Django app (source code)
├── tests/                 # Test suite
...
Any directory named `wagtail_mcp` is renamed to `wagtail_mcp`, which cookiecutter then resolves to the user's chosen project name in snake_case.
...
|---|---|---|
| `wagtail_mcp` | `wagtail_mcp` | `wagtail_color_picker` |
| `wagtail-mcp` | `wagtail-mcp` | `wagtail-color-picker` |
| `WagtailMcp` | `WagtailMcp` | `WagtailColorPicker` |
| `Wagtail MCP` | `Wagtail MCP` | `Wagtail Color Picker` |
| `Experimental MCP server for content operations from outside the CMS` | `Experimental MCP server for content operations from outside the CMS` | `A color picker field for Wagtail` |
| `https://github.com/org-name-or-username/wagtail-mcp` | `https://github.com/wagtail/wagtail-mcp` | `https://github.com/user/wagtail-color-picker` |
| `2026` | `2026` | `2026` |
